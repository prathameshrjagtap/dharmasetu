...
export default function ShlokaCard({ shloka }: ShlokaCardProps) {
  return (
    <article className="rounded-lg border border-stone-200 bg-white p-6 space-y-4">
      ...
      {/* Transliteration */}
      <div>
        <p className="text-sm font-medium text-stone-500 mb-1">Transliteration</p>
      ...
      {/* Meaning */}
      <div>
        <p className="text-sm font-medium text-stone-500 mb-1">Meaning</p>
      ...
      <div className="border-t border-stone-100 pt-4">
        <p className="text-sm font-medium text-stone-500 mb-1">Explanation</p>
